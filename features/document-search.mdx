...
Codanna is a local code intelligence MCP server and CLI for AI coding agents. Document search indexes markdown and text files for semantic retrieval alongside code — project documentation, RAG pipelines.
