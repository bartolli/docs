...
<CardGroup cols={2}>
  <Card title="Features" icon="sparkles" href="/features/semantic-search">
    Learn what Codanna can do for your workflow
  </Card>
  <Card title="Workflows" icon="route" href="/workflows/tool-tiers">
    Best practices for using Codanna with AI assistants
  </Card>
</CardGroup>
