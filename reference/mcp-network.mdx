...
Codanna is a local code intelligence MCP server and CLI for AI coding agents. Network mode exposes the MCP server over HTTP or HTTPS for multiple clients, with OAuth authentication and optional TLS.
